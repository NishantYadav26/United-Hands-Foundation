        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center gap-5 xl:gap-7">
            ...
            <Link to="/donate" data-testid="nav-donate">
              <button className="btn-gold px-5 py-2 text-sm hover:scale-105 transition-transform duration-200" style={{ padding: '10px 24px' }}>Donate Now</button>
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden mt-3 pb-4 flex flex-col gap-2 pt-3" style={{ borderTop: '1px solid var(--border-subtle)' }} data-testid="mobile-menu">
            ...
            <Link to="/donate" onClick={() => setMobileMenuOpen(false)}>
              <button className="btn-gold w-full mt-2 text-sm hover:scale-105 transition-transform duration-200" style={{ padding: '10px 24px' }}>Donate Now</button>
            </Link>
          </div>
        )}
      </div>
